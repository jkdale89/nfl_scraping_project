...
angular.module('Controllers', [])
  ...
  .controller('MainCtrl', ['$scope', '$routeParams', '$http', 'Data',
    function($scope, $routeParams, $http, data) {
      ...
      $scope.category_options = ["Teams", "Entire NFL", "Aggregates"];
      ...
      $scope.changeActiveCategory = function(str){
        ...
        $scope.active_type = $scope.graph_options[$scope.category_options.indexOf($scope.active_category)].cat_types[0];
...
.controller('teamsOuGraphCtrl', ['$scope', '$routeParams', '$timeout', '$http', 'Data', function($scope, $routeParams, $timeout, $http, db){
...
.controller('teamsAtsGraphCtrl', ['$scope', '$routeParams', '$timeout', '$http', 'Data', function($scope, $routeParams, $timeout, $http, db){
